...
const menuData: any = [
    ...
    },
    {
        id: "landing",
       // label: 'Landing Page',
        label: 'Landing Page QVAC',
        link: "/#",                   // think link to main landing page set bydefault
        ...
        subItems: [
            {
               // id: 'onepage',
                ...
                //label: 'One Page',
                label: 'QVAC',
                //link: '#',               //this link will point to some specific page
                link: '/qvac',         // my qvac compoent created in pages>Qvac.tsx and routes are being set at routesall publicone 
                parentId: "landing"
            },
            // {
            //     id: 'productlanding',
